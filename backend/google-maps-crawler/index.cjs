...
const CONFIG = {
  ...
  searchKeywords: [
    ...
    // ========== MARKETPLACE TRANSPORTOWY - Rozszerzenie ==========
    
    // Przeprowadzki i transport mebli
    'firma przeprowadzkowa polska',
    ...
    // Transport zwierząt - rozszerzony
    'transport koni polska',
    'przewóz koni',
    'transport psów',
    ...
    'transport rzeczy',
    'transport bagażu',
    'usługi spedycyjne polska'
  ],
  maxBusinessesPerKeyword: 35, // 67 keywords × 35 = ~2350 firm (po deduplikacji ~900-1300) - czas: ~3.5h
  scrollDelay: 1500, // Zmniejszone z 2000ms dla szybszego działania
  actionDelay: 1000, // Zmniejszone z 1500ms dla szybszego działania
